...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" CssClass="divpan" BackColor="White" ForeColor="#6699FF" BorderColor="Aqua" DefaultButton="btnSearchStatusWork">
        <div>
            <fieldset>
                <legend>ค้นหาข้อมูล</legend>
                <div>
                    ชื่อสถานะการทำงาน :&nbsp;<asp:TextBox ID="txtSearchName" runat="server" CssClass="tb5" Width="230px" MaxLength="100"></asp:TextBox>
    ...
    <asp:Panel ID="Panel2" runat="server" ScrollBars="Horizontal" CssClass="divpan" BackColor="White" ForeColor="#6699FF" BorderColor="Aqua" DefaultButton="btnSubmitStatusWork">
        <div>
            <fieldset>
                ...
                <div>
                    <table>
                        <tr>
                            <td style="text-align: left; width: 240px"></td>
                        ...
                        <asp:GridView ID="GridView1" runat="server" Style="margin-left: auto; margin-right: auto; text-align: center; width: 100%"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="ID" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="lblStatusWorkID" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Status_ID") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="ชื่อสถานะการทำงาน" ControlStyle-Width="820" HeaderStyle-BackColor="#0099FF" HeaderStyle-ForeColor="Aqua">
                                    <ItemTemplate>
                                        <asp:Label ID="lblStatusWorkNameEdit" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Status_Work") %>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtStatusWorkNameEdit" MaxLength="70" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Status_Work") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
