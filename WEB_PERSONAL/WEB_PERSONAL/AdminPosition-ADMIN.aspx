...
<asp:Panel ID="Panel1" runat="server" Height="70px" CssClass="divpan" BackColor="White" ForeColor="#6699FF" BorderColor="Aqua" DefaultButton="btnSearchAdminPosition">
    <div>
        <fieldset>
...
<asp:Panel ID="Panel2" runat="server" ScrollBars="Horizontal" Height="600px" CssClass="divpan" BackColor="White" ForeColor="#6699FF" BorderColor="Aqua" DefaultButton="btnSubmitAdminPosition">
    <div>
        <fieldset>
            <legend>Insert</legend>
            <div>
                <table>
                    <tr><td style="text-align: left; width:18px"></td>
                ...
                <Columns>
                    <asp:TemplateField HeaderText="รหัสตำแหน่งทางบริหาร" ControlStyle-Width="230" HeaderStyle-BackColor="#0099FF" HeaderStyle-ForeColor="Aqua">
                            ...
                            <asp:Label ID="lblAdminPositionIDEdit" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ADMIN_POSITION_ID") %>'></asp:Label>
                                    ...
                                    <EditItemTemplate>
                            		<asp:TextBox ID="txtAdminPositionIDEdit" MaxLength="4" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ADMIN_POSITION_ID") %>'></asp:TextBox>
                        		    </EditItemTemplate>
                    </asp:TemplateField>
