                 ...
                 <table>
                     ...
                     <tr>
                        ...
                        <td style="text-align: left; width: 170px;">
                            <asp:TextBox ID="txtZIPCODE" runat="server" Width="257px" CssClass="tb5"></asp:TextBox></td> 
                        <td style="text-align: left; width: 10px;"> </td> 
                        <td style="text-align: left; width: 170px;">
                     ...
                     <tr>
                         <td style="text-align: left; width: 30px;"> </td>
                        <td style="text-align: left; width: 80px;">
                           <asp:DropDownList ID="ddlDISTRICT" runat="server" OnSelectedIndexChanged="ddlDISTRICT_SelectedIndexChanged" Width="257px" AutoPostBack="true" CssClass="tb5"></asp:DropDownList></td> 
                        <td style="text-align: left; width: 10px;"> </td> 
                        <td style="text-align: left; width: 170px;">
                        <td style="text-align: left; width: 10px;"> </td> 
                        <td style="text-align: left; width: 170px;">
