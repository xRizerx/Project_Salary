...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="mp">
        ...
        <div class="master_dark_div_sec">
            <div>
                <asp:Label ID="Label22" runat="server" Text="เพิ่มเอกสารการลา" CssClass="master_dark_div_sec_title"></asp:Label>
            </div>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td class="auto-style67">
                                <asp:Panel ID="Panel5" runat="server" DefaultButton="LinkButton17">
                                    <asp:TextBox ID="TextBox16" runat="server" CssClass="master_dark_textbox" placeHolder="รหัสประชาชน"></asp:TextBox>
                                    <asp:LinkButton ID="LinkButton17" runat="server" CssClass="master_dark_button" OnClick="Button1_Click2">ตรวจสอบ</asp:LinkButton>
                                </asp:Panel>
                        ...
                        <tr>
                            ...
                            <td class="auto-style64">
                                <asp:DropDownList ID="DropDownList5" runat="server" DataSourceID="SqlDataSource3" DataTextField="LEAVE_TYPE_NAME" DataValueField="LEAVE_TYPE_ID" CssClass="master_dark_dropdown" OnDataBound="DropDownList5_DataBound">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style67">
                                <asp:DropDownList ID="DropDownList6" runat="server" DataSourceID="SqlDataSource1" DataTextField="LEAVE_STATUS_NAME" DataValueField="LEAVE_STATUS_ID" CssClass="master_dark_dropdown" OnDataBound="DropDownList6_DataBound">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style67">
                                <asp:TextBox ID="TextBox17" runat="server" CssClass="master_dark_textbox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style98">
                            ...
                            <td class="auto-style67">
                                <asp:TextBox ID="TextBox18" runat="server" CssClass="master_dark_textbox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style98">
                            ...
                            <td class="auto-style69">
                                <asp:TextBox ID="TextBox19" runat="server" Height="85px" TextMode="MultiLine" Width="298px" CssClass="master_dark_textbox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
        ...
        <div class="master_dark_div_sec">
            <div>
                <asp:Label ID="Label30" runat="server" Text="แก้ไขเอกสารการลา" CssClass="master_dark_div_sec_title"></asp:Label>
            </div>
            <div class="master_dark_div_sec_pre_in" id="sec3">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td class="auto-style77">
                                <asp:Panel ID="Panel1" runat="server" DefaultButton="LinkButton18">
                                    <asp:TextBox ID="TextBox15" runat="server" CssClass="master_dark_textbox"></asp:TextBox>
                                    <asp:LinkButton ID="LinkButton18" runat="server" CssClass="master_dark_button" OnClick="LinkButton18_Click">ค้นหา</asp:LinkButton>
                                </asp:Panel>
                        ...
                        <tr>
                            ...
                            <td class="auto-style79">
                                <asp:TextBox ID="TextBox2" runat="server" CssClass="master_dark_textbox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style95">
                            ...
                            <td class="auto-style77">
                                <asp:Panel ID="Panel3" runat="server" DefaultButton="LinkButton14">
                                    <asp:TextBox ID="TextBox3" runat="server" CssClass="master_dark_textbox" placeHolder="รหัสประชาชน"></asp:TextBox>
                                    <asp:LinkButton ID="LinkButton14" runat="server" CssClass="master_dark_button" OnClick="LinkButton14_Click">ตรวจสอบ</asp:LinkButton>
                                </asp:Panel>
                        ...
                        <tr>
                            ...
                            <td class="auto-style77">
                                <asp:Panel ID="Panel4" runat="server" DefaultButton="LinkButton15">
                                    <asp:TextBox ID="TextBox8" runat="server" CssClass="master_dark_textbox" placeHolder="รหัสประชาชน"></asp:TextBox>
                                    <asp:LinkButton ID="LinkButton15" runat="server" CssClass="master_dark_button" OnClick="LinkButton15_Click">ตรวจสอบ</asp:LinkButton>
                                </asp:Panel>
                        ...
                        <tr>
                            ...
                            <td class="auto-style77">
                                <asp:TextBox ID="TextBox9" runat="server" CssClass="master_dark_textbox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style95">
                            ...
                            <td class="auto-style77">
                                <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource3" DataTextField="LEAVE_TYPE_NAME" DataValueField="LEAVE_TYPE_ID" CssClass="master_dark_dropdown" OnDataBound="DropDownList1_DataBound">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style77">
                                <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource1" DataTextField="LEAVE_STATUS_NAME" DataValueField="LEAVE_STATUS_ID" CssClass="master_dark_dropdown" OnDataBound="DropDownList2_DataBound">
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="auto-style77">
                                <asp:TextBox ID="TextBox5" runat="server" CssClass="master_dark_textbox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style95">
                            ...
                            <td class="auto-style77">
                                <asp:TextBox ID="TextBox6" runat="server" CssClass="master_dark_textbox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td class="auto-style95">
                        ...
                        <tr>
                            <td class="auto-style95">&nbsp;</td>
                            <td class="auto-style77">
                                <asp:LinkButton ID="LinkButton13" runat="server" CssClass="master_dark_button" OnClick="LinkButton13_Click">แก้ไข</asp:LinkButton>
                            </td>
                        </tr>
                    </table>
        ...
        <div class="master_dark_div_sec" >
            <div>
                <asp:Label ID="Label34" runat="server" Text="ข้อมูลเอกสารการลา" CssClass="master_dark_div_sec_title"></asp:Label>
            </div>
            <div class="master_dark_div_sec_pre_in" id="sec4">
