        ...
        <div>
            <fieldset>
                ...
                <div>
                    ...
                    <asp:Button ID="btnSearchTitle" Text="Search" runat="server" CssClass="master_OAT_button"  />
    ...
    <asp:Panel ID="Panel2" runat="server" ScrollBars="Horizontal" CssClass="divpan" BackColor="White" ForeColor="#6699FF" BorderColor="Aqua">
        <div>
            <fieldset>
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="CITIZEN_ID" DataSourceID="SqlDataSource1" AllowPaging="True" AllowSorting="True" Width="982px">
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="Citizen_ID" DataNavigateUrlFormatString="CitizenDetails.aspx?CID={0}" DataTextField="Citizen_ID" HeaderText="รหัสบัตรประชาชน" />
                    </Columns>
                </asp:GridView>
